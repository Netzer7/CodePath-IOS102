...
class TwitterAPICaller: BDBOAuth1SessionManager {
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "85q94KzByA1xa8vchQ8tU3QB1", consumerSecret: "BZ1RPStfJEyQaIt3Nxj7T7h4XculnXuJS38zFTzbOoNvsUfqFY")
    var loginSuccess: (() -> ())?
